...
| 14 | [014-pinned-and-reviewable.md](014-pinned-and-reviewable.md) | Benchmark replaceable authoring backends against the end-to-end Tosca workflow, add detached evidence that covers both recording formats, and define fail-closed compatibility behavior; no authoring freeze is activated by the plan |
